                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-5 space-y-1 text-sm">
                      ...
                      <li>For videos, ensure good audio quality for better transcription</li>
        ...
        <div className={`mt-8 p-6 rounded-lg ${
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="mb-3">
                The Content Summarizer uses advanced AI to extract and summarize information from various media types:
              </p>
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li><strong>Videos:</strong> Transcribes audio and summarizes the content</li>
                <li><strong>Text:</strong> Processes and condenses text files into key points</li>
              </ul>
            </div>
          </div>
        </div>
