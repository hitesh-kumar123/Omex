...
const About = () => {
  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-gray-800 text-white' : 'bg-gray-100 text-gray-800'}`}>
      {/* Hero Section */}
      <div className={`py-20 px-4 ${isDark ? 'bg-gray-900' : 'bg-blue-50'} relative overflow-hidden animated-bg`}>
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-cover bg-center opacity-5"
               style={{backgroundImage: "url('https://images.unsplash.com/photo-1571171637578-41bc2dd41cd2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')"}}></div>
        </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-20 relative">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-center mb-8">
              <div className={`p-3 rounded-full ${isDark ? 'glass-dark' : 'glass'} mr-4`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className={`${isDark ? 'glass-dark glass-dark-card' : 'glass glass-card'} rounded-xl p-6`}>
                <div className="flex items-center mb-4">
                  <div className={`p-3 rounded-full ${isDark ? 'bg-yellow-500 bg-opacity-20' : 'bg-yellow-100'}`}>
                    <FaLightbulb className="text-yellow-400 text-xl" />
                  </div>
                  <h3 className="ml-3 text-lg font-bold">Code Optimization</h3>
                </div>
                <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Analyze your code and receive suggestions for improving performance, readability, and maintainability.
                </p>
              </div>
              ...
              <div className={`${isDark ? 'glass-dark glass-dark-card' : 'glass glass-card'} rounded-xl p-6`}>
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="ml-3 text-lg font-bold">Complexity Analysis</h3>
                </div>
                <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Understand the time and space complexity of your algorithms and identify potential bottlenecks.
                </p>
              </div>

              <div className={`${isDark ? 'glass-dark glass-dark-card' : 'glass glass-card'} rounded-xl p-6`}>
                <div className="flex items-center mb-4">
                  <div className={`p-3 rounded-full ${isDark ? 'bg-red-500 bg-opacity-20' : 'bg-red-100'}`}>
                    <FaExchangeAlt className="text-red-400 text-xl" />
                  </div>
                  <h3 className="ml-3 text-lg font-bold">Code Comparison</h3>
                </div>
                <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Compare different versions of your code to identify changes, improvements, and potential issues.
                </p>
              </div>
            </div>
        ...
        <div className="mb-20 relative overflow-hidden">
          <div className="absolute inset-0 opacity-5">
            <div className="absolute inset-0 bg-cover bg-center"
                 style={{backgroundImage: "url('https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')"}}></div>
          </div>
          <div className="relative z-10">
            <div className="flex items-center justify-center mb-8">
              <div className={`p-3 rounded-full ${isDark ? 'glass-dark' : 'glass'} mr-4`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className={`${isDark ? 'glass-dark glass-dark-card' : 'glass glass-card'} rounded-xl p-6 relative overflow-hidden`}>
                ...
                <div className="relative z-10">
                  <div className={`p-3 rounded-full ${isDark ? 'bg-blue-500 bg-opacity-20' : 'bg-blue-100'} mb-4 inline-block`}>
                    <FaCode className="text-blue-400 text-xl" />
                  </div>
                  <h3 className="text-xl font-bold mb-3">Advanced AI</h3>
                  <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                    Powered by state-of-the-art AI models specifically trained on code analysis and optimization.
                  </p>
                </div>
              </div>
              ...
              <div className={`${isDark ? 'glass-dark glass-dark-card' : 'glass glass-card'} rounded-xl p-6 relative overflow-hidden`}>
                ...
                <div className="relative z-10">
                  <div className={`p-3 rounded-full ${isDark ? 'bg-purple-500 bg-opacity-20' : 'bg-purple-100'} mb-4 inline-block`}>
                    <FaUsers className="text-purple-400 text-xl" />
                  </div>
                  <h3 className="text-xl font-bold mb-3">Developer-Focused</h3>
                  <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                    Built by developers, for developers, with a focus on practical, actionable insights.
                  </p>
                </div>
              </div>
              ...
              <div className={`${isDark ? 'glass-dark glass-dark-card' : 'glass glass-card'} rounded-xl p-6 relative overflow-hidden`}>
                <div className="absolute top-0 right-0 w-24 h-24 -mr-8 -mt-8 opacity-10">
                  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#10B981" d="M45.3,-51.2C58.3,-42.3,68.5,-27.2,73.8,-9.5C79.1,8.1,79.4,28.3,69.9,41.8C60.4,55.3,41.1,62.1,21.8,69.2C2.6,76.3,-16.6,83.7,-30.1,77.8C-43.6,71.9,-51.5,52.7,-59.3,34.9C-67.1,17.1,-74.9,0.7,-73.1,-15.2C-71.3,-31.1,-60,-46.4,-45.7,-55.3C-31.4,-64.2,-14.1,-66.7,1.3,-68.2C16.7,-69.7,32.3,-60.1,45.3,-51.2Z" transform="translate(100 100)" />
                  </svg>
                </div>
                <div className="relative z-10">
                  <div className={`p-3 rounded-full ${isDark ? 'bg-green-500 bg-opacity-20' : 'bg-green-100'} mb-4 inline-block`}>
                    <FaTools className="text-green-400 text-xl" />
                  </div>
                  <h3 className="text-xl font-bold mb-3">Comprehensive Tools</h3>
                  <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                    A complete suite of tools for all aspects of code quality and improvement.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mb-20 relative overflow-hidden">
          <div className="absolute inset-0 opacity-5">
            <div className="absolute inset-0 bg-cover bg-center"
                 style={{backgroundImage: "url('https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')"}}></div>
          </div>
          <div className="relative z-10">
            <div className="flex items-center justify-center mb-8">
              <div className={`p-3 rounded-full ${isDark ? 'glass-dark' : 'glass'} mr-4`}>
            ...
            <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
              <div className={`p-6 rounded-lg ${isDark ? 'glass-dark glass-dark-card' : 'glass glass-card'} relative overflow-hidden`}>
                <div className="absolute top-0 right-0 w-24 h-24 -mr-8 -mt-8 opacity-10">
                  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#EF4444" d="M45.3,-51.2C58.3,-42.3,68.5,-27.2,73.8,-9.5C79.1,8.1,79.4,28.3,69.9,41.8C60.4,55.3,41.1,62.1,21.8,69.2C2.6,76.3,-16.6,83.7,-30.1,77.8C-43.6,71.9,-51.5,52.7,-59.3,34.9C-67.1,17.1,-74.9,0.7,-73.1,-15.2C-71.3,-31.1,-60,-46.4,-45.7,-55.3C-31.4,-64.2,-14.1,-66.7,1.3,-68.2C16.7,-69.7,32.3,-60.1,45.3,-51.2Z" transform="translate(100 100)" />
                  </svg>
                </div>
                <div className="relative z-10">
                  <h3 className="text-xl font-bold mb-4 flex items-center">
                    <span className={`inline-block p-2 rounded-full ${isDark ? 'bg-red-500 bg-opacity-20' : 'bg-red-100'} mr-3`}>
              ...
              <div className={`p-6 rounded-lg ${isDark ? 'glass-dark glass-dark-card' : 'glass glass-card'} relative overflow-hidden`}>
                ...
                <div className="relative z-10">
                  <h3 className="text-xl font-bold mb-4 flex items-center">
                    <span className={`inline-block p-2 rounded-full ${isDark ? 'bg-blue-500 bg-opacity-20' : 'bg-blue-100'} mr-3`}>
              ...
              <div className={`p-6 rounded-lg ${isDark ? 'glass-dark glass-dark-card' : 'glass glass-card'} relative overflow-hidden`}>
                ...
                <div className="relative z-10">
                  <h3 className="text-xl font-bold mb-4 flex items-center">
                    <span className={`inline-block p-2 rounded-full ${isDark ? 'bg-purple-500 bg-opacity-20' : 'bg-purple-100'} mr-3`}>
              ...
              <div className={`p-6 rounded-lg ${isDark ? 'glass-dark glass-dark-card' : 'glass glass-card'} relative overflow-hidden`}>
                ...
                <div className="relative z-10">
                  <h3 className="text-xl font-bold mb-4 flex items-center">
                    <span className={`inline-block p-2 rounded-full ${isDark ? 'bg-green-500 bg-opacity-20' : 'bg-green-100'} mr-3`}>
