  ...
  return (
    <div className="min-h-screen bg-gray-800 text-white py-12 px-4">
      <div className="container mx-auto">
        ...
        {/* Mission Section */}
        <div className="bg-gray-700 rounded-lg p-8 mb-16 shadow-xl">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-10 text-center">Why Choose CodeOptimize?</h2>
...
const FeatureCard = ({ icon, title, description }) => (
  <div className="bg-gray-700 rounded-lg p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:transform hover:-translate-y-1">
...
const TechItem = ({ name }) => (
  <div className="bg-gray-800 rounded-lg p-4 shadow-md hover:bg-gray-600 transition-colors duration-200">
