  ...
  const teamMembers = [
    {
      ...
      social: {
        ...
        instagram: "https://www.instagram.com/roshansuthar1105/",
      },
    },
    {
      id: 2,
      ...
      <div className="flex flex-col md:flex-row relative z-10">
        ...
        <div className="md:w-2/5 flex items-center justify-center p-6">
          <div className="relative">
            ...
            <div
              className="w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden relative mx-auto
        ...
        <div className="p-6 md:w-3/5 relative">
          ...
          <div className="hidden md:block mb-6">
            <h3 className="text-2xl font-bold mb-1 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
              {member.name}
            </h3>
            <p className={`text-blue-400 font-medium`}>{member.role}</p>
          </div>
    ...
    >
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            <p className={`${isDark ? "text-gray-300" : "text-gray-600"}`}>
              OMEX was created by a single developer with a passion for building
              tools that make coding more efficient and enjoyable, with some
              help from AI.
            </p>
          </div>
        </div>
        ...
        {/* Contact Section */}
        <div
          className={`max-w-4xl mx-auto p-8 rounded-2xl backdrop-blur-lg ${
            isDark
              ? "bg-gray-900/40 border border-gray-700/50"
              : "bg-white/30 border border-white/50"
        ...
        >
          ...
          <div className="relative z-10 text-center">
            ...
            >
              Have questions, feedback, or ideas for collaboration? I'd love to
              hear from you! Feel free to reach out through the contact form.
            </p>
            <a
              href="/contact"
