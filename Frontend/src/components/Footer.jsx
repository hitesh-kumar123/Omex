...
const Footer = () => {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-16">
          {/* 🔹 Brand Section */}
          <div className="space-y-6 flex flex-col items-start">
            ...
            >
              ...
              generation tools. OMEX helps developers write better, cleaner, and
              more efficient code.
            </p>
          ...
          {/* 🔹 Company Section */}
          <div className="flex flex-col space-y-4 sm:mx-20 mt-5 sm:mt-0">
            <h3
